...
public class BootInform extends AbstractDeviceInform {

  private static final long serialVersionUID = 2162922435204752652L;

  private ValueChangeInform valueChangeNotification;

  public BootInform() {
    setInformTypeList(new ArrayList<>());
    getInformTypeList().add(TR069InformType.BOOT);
  }
