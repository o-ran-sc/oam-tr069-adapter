...
public class ValueChangeInform extends AbstractDeviceInform {

  private static final long serialVersionUID = 4207077925048228371L;

  private ValueChangeInform valueChangeNotification;

  public ValueChangeInform() {
    setInformTypeList(new ArrayList<>());
    getInformTypeList().add(TR069InformType.VALUECHANGE);
  }
