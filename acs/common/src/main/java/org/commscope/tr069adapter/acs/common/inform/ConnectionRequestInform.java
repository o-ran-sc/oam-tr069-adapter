...
public class ConnectionRequestInform extends AbstractDeviceInform {

  private static final long serialVersionUID = -3779809288879394206L;

  public ConnectionRequestInform() {
    setInformTypeList(new ArrayList<>());
    getInformTypeList().add(TR069InformType.CONNECTIONREQUEST);
  }
