...
public class FROpResultTest {
  ...
  public void processOpResultWithNoPendingRequestTest() throws Exception {
    ...
    try {
      ...
      entity.setOpCode(TR069OperationCode.FACTORY_RESET.getOperationCode());
