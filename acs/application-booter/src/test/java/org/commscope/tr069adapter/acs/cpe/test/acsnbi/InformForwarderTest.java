...
public class InformForwarderTest {
  ...
  @Autowired
  private DeviceInformForwarder deviceInformForwarder;
  ...
  public void processInformPnPTest() throws Exception {
    ...
    try {
      ...
      DeviceInform inform = new DeviceInform();
      inform.setDeviceDetails(tr069DeviceDetails);
      List<InformType> informTypeList = new ArrayList<InformType>();
      informTypeList.add(TR069InformType.BOOTSTRAP);
      inform.setInformTypeList(informTypeList);
      deviceInformForwarder.onMessage(inform);
      assertTrue(true);
    } catch (Exception e) {
      fail(e.getMessage());
    }
