...
public class TCInformTest {
  ...
  public void processInformPnPTest() throws Exception {
    ...
    try {
      ...
      session.setDeviceId("0005B9519094");
      session.setSessionId("sessionId4");
      ...
      Mockito.when(sessionManager.generateUniqueSessionID()).thenReturn("sessionid5");
