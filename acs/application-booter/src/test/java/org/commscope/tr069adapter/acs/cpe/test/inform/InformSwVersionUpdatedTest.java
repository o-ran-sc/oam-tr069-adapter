...
public class InformSwVersionUpdatedTest {
  @Autowired
  ...
  @Test
  public void processSwUpdateInformPnPTest() throws Exception {
    ...
    try {
      ...
      Mockito.doNothing().when(deviceEventsMapperNotificationService)
          .processDeviceNotification(Mockito.any(DeviceInform.class));
      ...
      tr069DeviceDetails.setSoftwareVersion("10.0");
      tr069DeviceDetails.setHardwareVersion("xxx");
