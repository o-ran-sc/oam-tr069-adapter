...
public class DOOpResultTest {
  ...
  public void processOpResultWithNoPendingRequestTest() throws Exception {
    ...
    try {
      ...
      entity.setOpCode(TR069OperationCode.DELETE_OBJECT.getOperationCode());
