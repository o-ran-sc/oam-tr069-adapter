...
public class EmptyRequestWithPendingGPARequest extends EmptyRequestWithPendingRequest {
  ...
  public DeviceRPCRequest getDeviceRPCRequest(TR069DeviceDetails tr069DeviceDetails) {
    ...
    parameterDTO.setDataType("Boolean");
    parameterDTO.setParamValue("true");
    parameters.add(parameterDTO);

    OperationDetails opDetails = new OperationDetails();
    opDetails.setOpCode(TR069OperationCode.GET_PARAMETER_ATTRIBUTES);
