...
public class SPAOpResultTest {
  ...
  public void processOpResultWithNoPendingRequestTest() throws Exception {
    String exampleOpResult =
        "<ns3:Envelope xmlns:ns1=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:ns4=\"urn:dslforum-org:cwmp-1-0\" xmlns:ns3=\"http://schemas.xmlsoap.org/soap/envelope/\"><ns3:Header><ns4:ID ns3:mustUnderstand=\"1\">12653738</ns4:ID></ns3:Header><ns3:Body><ns4:SetParameterAttributesResponse/></ns3:Body></ns3:Envelope>";
    ...
    try {
      ...
      entity.setOpCode(TR069OperationCode.SET_PARAMETER_ATTRIBUTES.getOperationCode());
